...
public class MethodsExercises {
    ...
    public static int getNumberBetweenTwoNumbers() {
        Scanner scanner = new Scanner(System.in);
        scanner.useDelimiter("\n");
    ...
    public static void getFactorial(int userNum) {
        Scanner scanner = new Scanner(System.in);
        scanner.useDelimiter("\n");
    ...
    public static void main(String[] args) {
        doMath();
        getFactorial(getNumberBetweenTwoNumbers());
        doRollDice();
    }
}